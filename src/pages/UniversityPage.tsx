    ...
    const handleDownloadPDF = async () => {
        try {
            ...
            const soapData = {
                ...
                history: currentReport.e_historia_pasada || 'N/A',
                lastIntake: currentReport.e_ultima_ingesta || 'N/A',
    ...
    const handleDownloadRowPDF = async (row: any) => {
        try {
            ...
            const soapData = {
                ...
                history: row.data.e_historia_pasada || 'N/A',
                lastIntake: row.data.e_ultima_ingesta || 'N/A',
